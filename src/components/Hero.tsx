...
// these are nebula website src :skull:
const Hero = () => {
  ...
  useEffect(() => {
    const fetchJsonData = async () => {
      setLoading(true);
      try {
        const main = await fetch('https://raw.githubusercontent.com/YellowGregs/Test/refs/heads/main/Cubix.json');
        ...
        <div className="text-center">
          <div>
            <img
              ...
              alt="Cubix Logo" 
              className="w-40 h-40 mx-auto mb-6 drop-shadow-[0_0_15px_rgba(128,0,128,0.2)]"  
            />
          </div>

          <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-white to-white bg-clip-text text-transparent">
            Cubix - v{version}
          </h1>

          <p className="text-lg sm:text-xl text-white max-w-2xl mx-auto mb-12 px-4">
            Cubix is a Roblox Mobile Executor.
          </p>
